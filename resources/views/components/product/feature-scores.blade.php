    ...
    <div class="p-4 space-y-6">
        ...
        <div class="space-y-2">
            <div class="flex items-center justify-between">
                ...
                <span class="font-bold text-indigo-600 text-sm">60 FPS</span>
            </div>
        ...
        <div class="space-y-2">
            <div class="flex items-center justify-between">
                ...
                <span class="font-bold text-emerald-600 text-sm">8h 30m</span>
            </div>
            <div class="w-full bg-slate-100 rounded-full h-2">
        ...
        <div class="space-y-2">
            <div class="flex items-center justify-between">
                ...
                <span class="font-bold text-blue-600 text-sm">8.5/10</span>
            </div>
            <div class="w-full bg-slate-100 rounded-full h-2">
